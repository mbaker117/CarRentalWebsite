...
<html lang="en">
    ...
    <body class="login-page sidebar-collapse">
        ...
        <div class="page-header" filter-color="orange">
            <div class="page-header-image" style="background-image:url(../assets/img/cust2.jpg)"></div>

            <div class='alert alert-danger alert-dismissible fade show ml-auto mr-auto text-center ' id="alert" style="display: none;"role='alert'>
                ...
                <div class="container">
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-login card-plain">
                            <form class="form" method="Post" action="<%=request.getContextPath()%>/CustomerLoginRequest">
