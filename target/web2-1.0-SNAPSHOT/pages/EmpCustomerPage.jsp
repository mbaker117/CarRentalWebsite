<%-- 
    Document   : EmpCustomerPage
    Created on : May 21, 2020, 5:54:20 PM
    Author     : moham
--%>
    ...
    <head>
        ...
        <%
            ...
            if (request.getParameter("custSearch") == null || request.getParameter("custSearch").isEmpty()) {
                array = EmployeeHandler.retriveCustomers();
            } else {
                array = EmployeeHandler.searchCustomer(request.getParameter("custSearchType"), request.getParameter("custSearch"));
            }
            ...
            for (Customers e : array) {
                ...
                table += "     <form method='Post' action='" + request.getContextPath() + "/EmpCustomerServer'> <input type='submit' class='dropdown-item ' value='Delete'   ></input>";
                ...
                table += "     <form method='Post' target='_blank'action='EmpCustomerRentHistoryPage.jsp'> <input type='submit' class='dropdown-item ' value='Rent History'   ></input>";
                table += "<input type='text'  name='custId' hidden='true' value='" + e.getId() + "'></input>";
        ...
        <%            boolean isAlert = false;
            String op = (String) session.getAttribute("empCustOp");
            String alertTxt = "";
            String alertColor = "";
            if (op == null) {
                isAlert = false;
                ...
                int res = (Integer) session.getAttribute("empCustRes");
                if (op.equals("login")) {
                ...
                session.removeAttribute("empCustOp");
                session.removeAttribute("empCustRes");
                        ...
                        <div class="card ">
                            ...
                            <div class="card-header ">
                                ...
                                <div class=" d-inline-block col-lg-3   ">
                                    <form method="Post" action="EmpCustomerPage.jsp">  
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="Post" id="modalForm" action="<%=request.getContextPath()%>/EmpCustomerServer">
                            <div class="form-row ">
