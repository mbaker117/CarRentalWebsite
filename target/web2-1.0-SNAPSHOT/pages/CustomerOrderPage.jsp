...
<html lang="en">
    ...
    <head>
        ...
        <% String table = "";
            ...
            boolean kind = true;
            if (((String) request.getParameter("kind")) == null || ((String) request.getParameter("kind")).equals("all")) {
                kind = true;
                headTxt = "All Orders";
            } else {
                kind = false;
                headTxt = "Current Orders";
            }
            ArrayList<Order> array = CustomerHandler.retriveOrders(userId, kind);
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 ml-auto mr-auto text-center">
                            ...
                            <h5 class="description">Check out your orders carefully!! hope you are satisfied with it. </h5>
