<%-- 
    Document   : EmpLoginPage
    Created on : May 21, 2020, 5:51:47 PM
    Author     : moham
--%>
...
<html lang="en">
    ...
    <body class="login-page sidebar-collapse">
        ...
        <div class="page-header" filter-color="orange">
            <div class="page-header-image" style="background-image:url(../assets/img/c2.jpg)"></div>
                ...
                <div class="container">
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-login card-plain">
                            <form class="form" method="Post" action="<%=request.getContextPath()%>/EmpLoginRequest">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer text-center">
                                        <input  type="submit" value="Login"  class="btn btn-primary btn-round btn-lg btn-block"/></div>
                                </div>
                            </form>
                        </div>
                    </div>
