<%-- 
    Document   : CarRentHistory
    Created on : May 21, 2020, 4:52:56 AM
    Author     : moham
--%>
...
<html>
    ...
    <head>
        ...
        <% String table = "";
            ArrayList<Order> array = EmployeeHandler.rentHistory("carId", Integer.parseInt(request.getParameter("carId")));
                    ...
                    <div class="header-body">
                        ...
                        <div class="row align-items-center py-4">
                            <div class="col-lg-6 col-7">
                                <h6 class="h2 text-white d-inline-block mb-0">Car: <%= request.getParameter("carId") %>&nbsp;</h6>
