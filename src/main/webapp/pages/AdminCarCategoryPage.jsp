...
<html>
    ...
    <head>
        ...
        <% String table = "";
            ...
            ArrayList<CarCategory> array = AdminHandler.retriveCarCategory();
            ...
            for (CarCategory e : array) {
                ...
                table += "     <form method='Post' action='" + request.getContextPath() + "/AdminCarCategoryServer'> <input type='submit' class='dropdown-item ' value='Delete'   ></input>";
        ...
        <%            boolean isAlert = false;
            String op = (String) session.getAttribute("adminCatOp");
            String alertTxt = "";
            String alertColor = "";
            if (op == null) {
                isAlert = false;
                ...
                int res = (Integer) session.getAttribute("adminCatRes");
                if (op.equals("add")) {
                    if (res == 1) {
                ...
                session.removeAttribute("adminCatOp");
                session.removeAttribute("adminCatRes");
            }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="Post" id="modalForm" action="<%=request.getContextPath()%>/CarCategoryServer">
                            <div class="form-row ">
