    ...
    <head>
        ...
        <% String table = "";
          response.setHeader("Pragma", "No-cache");
            ...
            ArrayList<Order> array = EmployeeHandler.retriveOrders();
            ...
            for (Order e : array) {
                ...
                table += "</th>";
                table += " <td class='budget' id='tUsername'>" + EmployeeHandler.getCustomerName(e.getCustomerId()) + "</td>";
                ...
                table += "     <form method='Post' action='" + request.getContextPath() + "/EmpOrderServer'> <input type='submit' class='dropdown-item ' value='Delete'   ></input>";
               ...
               if(!checked){
                table += "     <form method='Post' action='" + request.getContextPath() + "/EmpOrderServer'> <input type='submit' class='dropdown-item ' value='Check Out'   ></input>";
                table += "<input type='text'  name='orderId' hidden='true' value='" + e.getId() + "'></input>";
            ...
            ArrayList<Customers> array2 = EmployeeHandler.retriveCustomers();
            ...
            ArrayList<Integer> array3 = EmployeeHandler.retriveAvailableCars();
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="Post" id="modalForm" action="<%=request.getContextPath()%>/EmpOrderServer">
                            <div class="form-row  ">
