...
<html>
    ...
    <head>
        ...
        <% String table = "";
            ...
            ArrayList<Car> array = AdminHandler.retriveCars();
            ...
            for (Car e : array) {
                ...
                table += " <td><span class='completion mr-2' id='tAddress'>" + AdminHandler.getCatName(e.getCategoryId()) + "</span></td>";
                ...
                table += "     <form method='Post' action='" + request.getContextPath() + "/CarServer'> <input type='submit' class='dropdown-item ' value='Delete'   ></input>";
                ...
                table += "     <form method='Post' target='_blank'action='AdminCarRentHistoryPage.jsp'> <input type='submit' class='dropdown-item ' value='Rent History'   ></input>";
                table += "<input type='text'  name='carId' hidden='true' value='" + e.getId() + "'></input>";
                table += "</form>";
                table += "     </div>";
                table += "   </div>";
            ...
            String catOptions = "";
            ArrayList<CarCategory> array2 = AdminHandler.retriveCarCategory();
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="Post" id="modalForm" action="<%=request.getContextPath()%>/AdminCarServer">
                            <div class="form-row ">
