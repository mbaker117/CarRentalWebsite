...
<html lang="en">
    ...
    <head>
        ...
        <% String table = "";
            ...
            response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
            response.setDateHeader("Expires", -1);
            ArrayList<Car> array = CustomerHandler.retriveCars();
            ...
            for (Car e : array) {
                ...
                table += " <td><span class='completion mr-2' id='tAddress'>" + CustomerHandler.getCatName(e.getCategoryId()) + "</span></td>";
                ...
                table += "   <td><span class='badge  text-" + color1 + " badge-dot '> <i class='bg-" + color1 + "'></i> <span class='status'>" + text1 + "</span> </span>";
                boolean avilable = e.isAvailable();
                String color2 = avilable ? "success" : "danger";
                String text2 = avilable ? "Yes" : "No";
                table += "  </td>";
                table += "   <td><span class='badge  text-" + color2 + " badge-dot'> <i class='bg-" + color2 + "'></i> <span class='status'>" + text2 + "</span> </span>";
                table += "  </td>";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 ml-auto mr-auto text-center">
                            ...
                            <h5 class="description">Here you can find all cars that you can rent </h5>
                            <div class="table-responsive">
                                <table class="table align-items-center  table-flush">
                                    <thead class="thead-flash">
                                       <tr>
